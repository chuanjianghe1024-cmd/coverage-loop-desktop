...
public final class TestResults {
    ...
    public static TestExecutionResult collectTestExecutionResult(CollectOptions options) {
        ...
        int tests = fallback != null && fallback.tests != null ? fallback.tests : xmlSummary.tests;
        int failures = fallback != null && fallback.failures != null ? fallback.failures : xmlSummary.failures;
        int errors = fallback != null && fallback.errors != null ? fallback.errors : xmlSummary.errors;
        int skipped = fallback != null && fallback.skipped != null ? fallback.skipped : xmlSummary.skipped;
