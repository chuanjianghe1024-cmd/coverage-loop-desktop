...
const routes = new Set(['/round/records','/round/file','/statistics/configs','/statistics/save','/statistics/delete','/statistics/preview','/projects','/project/open','/config/save','/config/load','/command/preview','/run/start','/run/stop','/state','/history','/history/detail','/history/delete']);
